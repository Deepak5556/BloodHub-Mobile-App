...
import 'o_t_pverify_model.dart';
export 'o_t_pverify_model.dart';
                            ...
                            child: SizedBox(
                              ...
                              child: Stack(
                                children: [
                                      ...
                                      child: PinCodeTextField(
                                        ...
                                        pinTheme: PinTheme(
                                          ...
                                          activeColor:
                                              FlutterFlowTheme.of(context)
                                                  .primaryText,
                                          inactiveColor: const Color(0xFF454040),
                                          selectedColor:
                                              FlutterFlowTheme.of(context)
                                                  .primary,
                                        ),
                                  ...
                                  Align(
                                    alignment:
                                        const AlignmentDirectional(-0.91, 0.66),
                                    child: Icon(
                                  ...
                                  Align(
                                    alignment:
                                        const AlignmentDirectional(-0.77, 0.69),
                                    child: Padding(
                                      padding: const EdgeInsetsDirectional.fromSTEB(
                                          2.0, 0.0, 0.0, 0.0),
                                  ...
                                  Align(
                                    ...
                                    child: InkWell(
                                      ...
                                      child: Text(
                                        FFLocalizations.of(context).getText(
                                          '9d604gv5' /* Wrong number? */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              fontFamily: 'Readex Pro',
                                              color: const Color(0xFFDB0F0F),
                                              fontSize: 12.0,
                                              letterSpacing: 0.0,
                                            ),
                                      ),
                      ...
                      children: [
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                FFLocalizations.of(context).getText(
                                  'do59w51a' /* Didn't received the OTP? */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            highlightColor: Colors.transparent,
                            onTap: () async {
                              final phoneNumberVal = widget.moblieNumber;
