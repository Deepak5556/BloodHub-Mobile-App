...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'DonateForm',
          path: '/donateForm',
          builder: (context, params) => const DonateFormWidget(),
        ),
        FFRoute(
          name: 'SearchDonars',
          path: '/searchDonars',
          builder: (context, params) => const SearchDonarsWidget(),
        ),
        FFRoute(
          name: 'Table',
          path: '/table',
        ...
        FFRoute(
          name: 'DonateFormCopy',
          path: '/donateFormCopy',
          builder: (context, params) => const DonateFormCopyWidget(),
        ),
        FFRoute(
          name: 'otplogin',
          path: '/otplogin',
          builder: (context, params) => const OtploginWidget(),
        ),
        FFRoute(
          name: 'OTPverify',
          path: '/oTPverify',
          builder: (context, params) => OTPverifyWidget(
            moblieNumber: params.getParam(
              'moblieNumber',
              ParamType.String,
            ),
          ),
